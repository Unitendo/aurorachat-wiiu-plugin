 ...
 *
 * Originally sourced from: https://github.com/wiiu-env/NotificationModule/raw/refs/heads/main/src/shaders/Texture2DShader.h
 */
...
public:
    ...
    void setScale(const float *vec) {
        VertexShader::setUniformReg(scaleLocation, 4, vec);
    }
    void setColorIntensity(const float *vec) {
        PixelShader::setUniformReg(colorIntensityLocation, 4, vec);
    }
    void setBlurring(const float *vec) {
        PixelShader::setUniformReg(blurLocation, 4, vec);
    }
